  ...
  return (
    <>
      <div className="brand">
        ...
        <div>
          <h3>{getCookie('custom') ?? 'DataOn'}</h3> <span>Jakarta Timur</span>
        </div>
      </div>
      <hr />
      ...
      <Menu theme="light" mode="inline">
        ...
        <Menu.Item key="2">
          <NavLink to="/multilang">
            <span
              className="icon"
              style={{
                background: page === 'multilang' ? color : '',
              }}
            >
              {tables}
            </span>
            <span className="label">Multi Language</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="3">
          <NavLink to="/routes">
            ...
            <span className="label">Dynamic Routers</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="4">
          <NavLink to="/billing-x">
            <span
              className="icon"
              style={{
                background: page === 'billing' ? color : '',
            ...
            <span className="label">Automation cli</span>
          </NavLink>
        </Menu.Item>
        ...
        <Menu.Item key="6">
          <NavLink to="/profile">
            ...
            <span className="label">Semantic Release</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="7">
          <NavLink to="/sign-in">
            <span className="icon">{signin}</span>
            <span className="label">Change log commit</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="8">
          <NavLink to="/sign-up">
